 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'RJYI_9=er$(+..G!V2SH!3F%|6_EQ8|b3|v!9&|6;bXGWz&nRu$X$m}*_fv0x4P<');
define('SECURE_AUTH_KEY',  'Q~8-@]V!vol %|UE6Q#-y~55hUI{,(e(>gi` y3XZ:7:Mw@aICD2]r$ k+0hTe!x');
define('LOGGED_IN_KEY',    '!WTC!kE@4q+|{4A@^%_FFBjtMEIv<4tR1J2+*5%3C>1nN{]cZkdpJBh~|6Qv2vZ4');
define('NONCE_KEY',        'fFpYTYD:a<|{M||%-[$MAhtevAC1@L4Wa]_CTnBg:0ke6?2TjB+Wx5@0EE:7gq4%');
define('AUTH_SALT',        '6}&O;MRHf%ad,lIjCET[:uK#`>)&H /J Kwg7ot3AOx+4|Dwz,cz$NzeUt%ztA-s');
define('SECURE_AUTH_SALT', '`umsJcZxkO:2=J7s64E<K%OQ]-;7[GCW_B];!kG8$`)Za+rQ^$)~2T>dq5bk~2WX');
define('LOGGED_IN_SALT',   '-  `f}o-<phT6!L5cUvll;<^}n+iDjLj2l&r}lgvuu{)mifPr?Ie~Vi7-?qW[/H+');
define('NONCE_SALT',       '4{zS-^`5j|AD|z;hh/fT6+}gAe_?D>V;|)|U{lOnZSlc>3*B(S-CrU>aB!!=Jai-');
